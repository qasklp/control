      ...
      <div class="main-panel">
        <div class="content-wrapper">
           <?php
            ...
            ?>
            <div class="row">
              <div class="col-12 mb-4 mb-xl-0" style='padding-right: 0;'>
                <h3 class="font-weight-bold" style='margin-bottom: 20px; float: left;'><?=sysusers?></h3><button type="button" class="btn btn-info btn-ti-star" id='add_event' data-toggle="modal" data-target="#AddUserModal" style="margin:-10px 0 10px 10px;">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h3 class="modal-title" id="exampleModalCenterTitle">Додати користувача</h3>
                        </div>
                ...
                $(document).ready(function(){
                    $(":checkbox").on("click", function(){
                      ...
                      $.ajax({
                        ...
                        url: 'usertogroupresponse.php?user=' + $( this ).attr('user')+'&group='+ this.id + '&action=' + $( this ).prop( "checked" ),
