...
$objPHPExcel->setActiveSheetIndex(0)
			->setCellValue('A1', $scan_titles[5]['title'])
			->setCellValue('B1', $scan_titles[6]['title'])
			->setCellValue('C1', $scan_titles[7]['title'])
			->setCellValue('D1', $scan_titles[8]['title'])
			->setCellValue('E1', $scan_titles[1]['title'])
			->setCellValue('F1', $scan_titles[4]['title'])
			->setCellValue('G1', $scan_titles[3]['title']);
...
for($i=0; $i<count($scan_tbl); $i++){
	...
	$objPHPExcel->setActiveSheetIndex(0)
			->setCellValue('A'.$count, $scan_tbl[$i]['zone'])
			->setCellValue('B'.$count, $scan_tbl[$i]['row'])
			->setCellValue('C'.$count, $scan_tbl[$i]['col'])
			->setCellValue('D'.$count, $scan_tbl[$i]['price'])
			->setCellValueExplicit('E'.$count, $scan_tbl[$i]['barcode'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValue('F'.$count, $scan_tbl[$i]['status'])
			->setCellValue('G'.$count, $scan_tbl[$i]['time']);
...
$objPHPExcel->getActiveSheet()->setTitle('Barcodes base');
...
$path = 'C:\OpenServer\domains\control\admin\reports\\'.$eventname.'_base.php';
