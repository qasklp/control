...
<?php
  ...
  if(isset($_POST['user']) && isset($_POST['pass'])){
    $usr = new User('ctrl','ctrl');
    if($usr->login($_POST['user'], $_POST['pass']) == 1){
      $_SESSION['user_id'] = $usr->id;
      $_SESSION['user_login'] = $usr->login;
      $_SESSION['user_password'] = $usr->password;
      ...
      if($usr->role == 'visitor'){
        header ('Location: http://'.$_SERVER['SERVER_ADDR'].'/admin/stat.php');
      }

      if($usr->role == 'organizator'){
      ...
      if($usr->role == 'guest'){
        header ('Location: http://'.$_SERVER['SERVER_ADDR'].'/admin/load_guests.php');
      }
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="/admin/login.php" method="post">
                ...
                <div class="mt-3">
                   <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">ВХІД</button>
                </div>
