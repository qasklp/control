...
$objPHPExcel->setActiveSheetIndex(0)
			->setCellValue($scan_titles[0]['cell'].'1', $scan_titles[0]['title'])
			->setCellValue($scan_titles[1]['cell'].'1', $scan_titles[1]['title'])
			->setCellValue($scan_titles[2]['cell'].'1', $scan_titles[2]['title'])
			->setCellValue($scan_titles[3]['cell'].'1', $scan_titles[3]['title'])
			->setCellValue($scan_titles[4]['cell'].'1', $scan_titles[4]['title'])
			->setCellValue($scan_titles[5]['cell'].'1', $scan_titles[5]['title'])
			->setCellValue($scan_titles[6]['cell'].'1', $scan_titles[6]['title'])
			->setCellValue($scan_titles[7]['cell'].'1', $scan_titles[7]['title'])
			->setCellValue($scan_titles[8]['cell'].'1', $scan_titles[8]['title']);
...
$count = 2;
for($i=0; $i<count($scan_tbl); $i++){
	//echo $zone->is_fan(intval($scan_tbl[$i]['zone_id']))."**<br/>";
	//echo $scan_tbl[$i]['zone_id']."<br/>";
	if($zone->is_fan(intval($scan_tbl[$i]['zone_id'])) == 1){
		$scan_tbl[$i]['row'] = "";
		$scan_tbl[$i]['col'] = "";
	}

	$objPHPExcel->setActiveSheetIndex(0)
			->setCellValue('A'.$count, $scan_tbl[$i]['id'])
			->setCellValueExplicit('B'.$count, $scan_tbl[$i]['barcode'], PHPExcel_Cell_DataType::TYPE_STRING)
			->setCellValue('C'.$count, $scan_tbl[$i]['ctrl'])
			->setCellValue('D'.$count, $scan_tbl[$i]['time'])
			->setCellValue('E'.$count, $scan_tbl[$i]['status'])
			->setCellValue('F'.$count, $scan_tbl[$i]['zone'])
			->setCellValue('G'.$count, $scan_tbl[$i]['row'])
			->setCellValue('H'.$count, $scan_tbl[$i]['col'])
			->setCellValue('I'.$count, $scan_tbl[$i]['price']);

	$count++;
	echo "A".$count." - ".$scan_tbl[$i]['id']." - ".$scan_tbl[$i]['barcode']."<br/>";
}


// Rename worksheet
echo date('H:i:s') , " Rename worksheet" , EOL;
$objPHPExcel->getActiveSheet()->setTitle('Scan log');
...
$path = 'C:\OpenServer\domains\control\admin\reports\\'.$eventname.'_log.php';
