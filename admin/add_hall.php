<?php
    ...
    if($hall->add_hall($validation->text_validation($_GET['name']), $validation->text_validation($_GET['addr']), $validation->text_validation($_GET['viewbox']), $validation->text_validation($_GET['scale'])) == 1){

        echo loca.$_GET['name'].locacrt;
